...
| RUNprr     | studymk               | ddset<br/>nr2d<br/>doplots | det_mprr()                    | methylation poor and rich regions               | dst-\*.txt<br/>\*ds-\*.pdf<br/>mdr-\*.tab<br/>mdr-\*.bed<br/>mpr-\*.txt<br/>mrr-\*.txt<br/>rmp-\*.txt<br/>gwr-\*.txt |
| RUNrepcms  | replicate \*.mcalls   | covlist                    | cmStats()                     | replicate coverage and methylation statistics   | cms-\*.txt<br/>cms-\*.pdf                                                                                            |
| RUNrepcrl  | replicate \*.mcalls   | destrand                   | cmpSamples()                  | correlations between replicates                 | crl-\*\_rep\_\*.txt<br/>crl-\*\_rep\_\*.pdf                                                                          |
| RUNpwc     | studymk<br/>studymc   | -                          | cmpSites()                    | pairwise sample comparisons                     | pwc-\*.vs.\*.txt                                                                                                     |
| RUNagscrl  | studymk               | destrand                   | cmpSamples()                  | correlations between aggregate samples          | crl-\*.txt<br/>crl-\*.pdf                                                                                            |
