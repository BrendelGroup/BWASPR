...
#' @param outputfile If specified as other than "", the result is saved in the
#'   specified file. 
#'
...
#'   annotate_methylome(AmHE,genome_ann,outputfile="AmHE_methylome_ann.txt")
#'
#' @export
...
annotate_methylome <- function(mrobj,
    ...
    if (outputfile != ""){
        write.table(methylome_ann,file=outputfile,sep='\t',row.names=FALSE,
                    quote=FALSE)
    }
