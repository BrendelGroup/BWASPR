...
#' @param mrobj
#' @param if_plot ?An option to save the figure or not
#' @param output_file_dir ?An option to specify the dir/file names for output figure
#'
...
# =======
    ...
    ha = HeatmapAnnotation(df = data.frame(caste = sample_list))
    ha_gene = rowAnnotation(df = label_matrix['gene'], name = 'gene', show_annotation_name = TRUE, width = unit(2, "mm"), col = list(gene = c('No' =  "gray", 'Yes' = "blue")), annotation_name_side = 'top')
    ha_exon = rowAnnotation(df = label_matrix['exon'], name = 'exon', show_annotation_name = TRUE, width = unit(2, "mm"), col = list(exon = c('No' =  "gray", 'Yes' = "blue")), annotation_name_side = 'top')
    ha_pcexon = rowAnnotation(df = label_matrix['pcexon'], name = 'pcexon', show_annotation_name = TRUE, width = unit(2, "mm"), col = list(pcexon = c('No' =  "gray", 'Yes' = "blue")), annotation_name_side = 'top')
    ha_cds = rowAnnotation(df = label_matrix['CDS'], name = 'CDS', show_annotation_name = TRUE, width = unit(2, "mm"), col = list(CDS = c('No' =  "gray", 'Yes' = "blue")), annotation_name_side = 'top')
    ha_promoter = rowAnnotation(df = label_matrix['promoter'], name = 'promoter', show_annotation_name = TRUE, width = unit(2, "mm"), col = list(promoter = c('No' =  "gray", 'Yes' = "blue")), annotation_name_side = 'top')
